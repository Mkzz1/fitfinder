...
const MainScreen = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Get fit and stay healthy with GymExplorer</Text>
      <Text style={styles.sectionTitle}>Discover New Workout Spots</Text>
      ...
      <View style={styles.grid}>
        ...
        <TouchableOpacity style={styles.smallButton}>
          <Text style={styles.buttonText}>Specialty Gyms</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
